...
const quotationSchema = new mongoose.Schema({
    ...
    quotationDetails: {
        ...
        quotationNumber: { type: String, required: [true, 'quotationNumber is required'] },
        quotationPostfix: { type: String },
...
quotationSchema.index({ userId: 1, 'quotationDetails.quotationNumber': 1 }, { unique: true });
