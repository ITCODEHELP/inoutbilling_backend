...
const debitNoteSchema = new mongoose.Schema({
    ...
    debitNoteDetails: {
        ...
        dnNumber: { type: String, required: [true, 'D.N. Number is required'] },
        dnPostfix: { type: String },
        dnDate: { type: Date, required: [true, 'D.N. Date is required'] },
    ...
    // Totals
    totals: {
        totalDebitValue: { type: Number, default: 0 },
...
debitNoteSchema.index({ userId: 1, 'debitNoteDetails.dnNumber': 1 }, { unique: true });
