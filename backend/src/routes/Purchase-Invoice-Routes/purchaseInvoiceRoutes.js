...
} = require('../../controllers/Purchase-Invoice-Controller/purchaseInvoiceController');
const { uploadInvoiceAI, confirmExtraction } = require('../../controllers/Purchase-Invoice-Controller/purchaseInvoiceAIController');
